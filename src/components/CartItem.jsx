          ...
          <div className="flex gap-x-2 h-[36px] text-sm">
            <div className=" flex flex-1 max-w-[100px] items-center h-full border text-primary font-medium">
              <div
                ...
                className="flex-1 flex justify-center items-center cursor-pointer bg-red-300 h-full"
              >
                <IoMdRemove />
              </div>
              ...
              <div
                ...
                className="flex-1 h-full flex justify-center items-center cursor-pointer bg-blue-300"
              >
                <IoMdAdd />
              </div>
            </div>
